...
export interface ApiExperienceTagExperienceTag
  extends Struct.CollectionTypeSchema {
...
export interface ApiExperienceExperience extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    brand: Schema.Attribute.Media<'images', true> & Schema.Attribute.Required;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    experience_tags: Schema.Attribute.Relation<
      'oneToMany',
      'api::experience-tag.experience-tag'
    >;
    ...
    > &
      Schema.Attribute.Private;
    location: Schema.Attribute.Relation<'manyToMany', 'api::location.location'>;
    longitude: Schema.Attribute.Float;
...
export interface ApiJobOfferJobOffer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    numberOfPositions: Schema.Attribute.Integer &
      Schema.Attribute.Required &
...
export interface ApiLocationAccessInformationLocationAccessInformation
  ...
  attributes: {
    ...
    common_area: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    elevator: Schema.Attribute.Media<'images' | 'files', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    garden: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    other: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    shared_bathroom: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiLocationLocation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    disabledReservations: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    metaPixel: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiLongStaysZoneLongStaysZone
  ...
  attributes: {
    ...
    numSpaces: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
